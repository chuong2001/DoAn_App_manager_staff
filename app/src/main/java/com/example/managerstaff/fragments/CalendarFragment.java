...
public class CalendarFragment extends Fragment implements ItemTouchHelperListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter.setOnClickListener(position -> {
            if(IdUser!=IdAdmin) {
                ...
                intent.putExtra("id_part",listParts.get(index).getIdPart());
        ...
        if(IdUser==IdAdmin){
            binding.layoutNamePart.setVisibility(View.VISIBLE);
            ...
            binding.layoutNamePart.setVisibility(View.GONE);
        }
        ...
        binding.spNamePart.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                clickCallApiGetListCalendar(listParts.get(index).getIdPart());
            }
            @Override
        ...
        binding.datePicker1.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView view, int year, int month, int dayOfMonth) {
                ...
                int index=Support.getIndexOfName(Support.getNamePart(listParts),binding.txtNamePart.getText().toString());
                clickCallApiGetListCalendar((IdAdmin==IdUser)?listParts.get(index).getIdPart():user.getPart().getIdPart());
            }
        });
    ...
    private void clickCallApiGetListCalendar(int idPart) {
        binding.pbLoadData.setVisibility(View.VISIBLE);
        ApiService.apiService.getCalendar(Support.getAuthorization(requireActivity()),idPart,day).enqueue(new Callback<ListCalendarResponse>() {
            @Override
